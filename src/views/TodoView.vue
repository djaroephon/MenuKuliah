  <template>
    <div class="flex flex-col items-center mt-40 w-full"> <!-- Menggunakan margin-top untuk jarak dari atas -->
        ...
        <div class="flex items-center space-x-4">
          ...
          <div class="relative w-1/3">
            <select
              ...
              class="block w-full px-4 py-3 pr-8 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500 transition duration-200 ease-in-out appearance-none"
            >
          ...
          <div class="relative w-2/3">
            <input
              type="text"
              v-model="todoInput"
              class="block p-4 w-full text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500 transition duration-200 ease-in-out"
            ...
            <button
              type="submit"
              class="absolute top-0 right-0 p-2.5 h-full text-sm font-medium text-white bg-blue-700 rounded-e-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 transition duration-200 ease-in-out"
            >
              Add
            </button>
          </div>
